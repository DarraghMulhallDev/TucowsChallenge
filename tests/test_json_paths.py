...
def test_find_cheapest_path(db_connection, create_data_complex_path):
    os.environ['DB_NAME'] = os.getenv('TEST_DB_NAME')
    answers = json_paths.query_paths('{"queries": [{"cheapest": {"start": "a","end": "e" }}, {"cheapest": {"start": "a","end": "h" }}]}')
